...
bot = telebot.TeleBot('7083053513:AAEuIeH0cyocoN98AYMmSD2A73oBlsPGTMI')
...
def get_main_keyboard():
    ...
    keyboard.add(KeyboardButton("/attack"), KeyboardButton("/stop"))
    return keyboard
...
def welcome_start(message):
    ...
    response = f'🚀 Welcome, {user_name}! Try running this command: /help'
...
Vip  :
-> Attack Time : Unlimited
-> Multiple Attack Support 
-> Same Ip Multiple Attack 
...
def stop_attack():
    for proc in psutil.process_iter(attrs=['pid', 'cmdline']):
        try:
            ...
            if cmdline and "./mrin" in cmdline:
